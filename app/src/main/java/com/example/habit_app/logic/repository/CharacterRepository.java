...
//    }
//
////    public void increaseMaxHp(int characterId, int amount) {
////        new IncreaseMaxHpAsyncTask(characterDao, characterId, amount).execute();
////    }
//
////    public void increaseMaxXp(int characterId, int amount) {
////        new IncreaseMaxXpAsyncTask(characterDao, characterId, amount).execute();
////    }
//
...
//        new DecreaseXpAsyncTask(characterDao, characterId, amount).execute();
//    }
//
//
...
//    }
//
//    private static class DecreaseXpAsyncTask extends AsyncTask<Void, Void, Void> {
//        private final CharacterDao characterDao;
//        private final int characterId;
//        private final int amount;
//
//        private DecreaseXpAsyncTask(CharacterDao characterDao, int characterId, int amount) {
//            this.characterDao = characterDao;
//            this.characterId = characterId;
//            this.amount = amount;
//        }
...
//        @Override
//        protected Void doInBackground(Void... voids) {
//            characterDao.decreaseXp(characterId, amount);
//            return null;
//        }
//    }
//
